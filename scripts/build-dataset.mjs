...
// restrictedPassportTypes -> ./lib/negation-parsers.mjs
...
// isExplicitAnyNat -> ./lib/negation-parsers.mjs
...
// negationInfo (+ NEG_CUE_RE / NEG_CLAUSE_RE) and visaRequiredIso3 -> ./lib/negation-parsers.mjs

const unresolved = new Map(); // label -> count
const negationGaps = []; // entries we could not safely expand

// GEO_RESTRICTED_RE and NON_OPERATIONAL_RE -> ./lib/negation-parsers.mjs
