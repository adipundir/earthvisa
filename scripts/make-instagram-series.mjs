...
const FLAGS = {};
for (const cc of ["nr", "us", "kn", "ar", "st"]) {
  try {
...
const POSTS = [
  {
    ...
    slides: [
      ...
      { bg: "pacific-iss", bgPos: "center 45%", type: "stat", eyebrow: "First things first", value: "#3", title: "Nauru is the third-smallest country on Earth", rows: [["21 km²", "total area"], ["3,300 km", "from Australia"], ["Pacific", "just south of the equator"]] },
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "vegas-sign", bgPos: "center 40%", type: "text", eyebrow: "The K-1 fiance visa", heading: "How it works.", lines: ["US citizen partner files the petition - $675", "You get the K-1 visa - $265 + $250 integrity fee", "180 days to enter the US", "On entry, a 90-day clock starts"] },
      { bg: "vegas-wedding-chapel", bgPos: "center 60%", type: "stat", eyebrow: "The rule", value: "90", title: "days to get married. No extensions.", note: "Only to the person who petitioned for you - marrying someone else does not count." },
      ...
      { bg: "sf-city-hall", bgPos: "center 45%", type: "text", eyebrow: "After the wedding", heading: "Marriage is the halfway point.", lines: ["Permanent residence is a separate application after you marry", "Until then, your status hangs on that 90-day window"] },
      { bg: "earthrise", bgPos: "center 35%", type: "cta", headline: "Every US visa,<br>decoded.", sub: "Fees, timelines and fine print, from official sources only." },
    ],
  },
  {
    slug: "p04-us-visa-unlocks", flag: "us", source: "Source: each country's official entry rules, July 2026",
    slides: [
      { type: "cover", photo: "passport-desk", pos: "center 40%", inset: "us-visa-sticker",  headline: `Your US visa is secretly<br>a ${hl("second passport")}.`, sub: "For Indian passport holders, it unlocks 36 countries most people never use." },
      { bg: "earth-blue-marble", bgPos: "center 30%", type: "stat", eyebrow: "Verified in our data · Indian passports", value: "36", title: "countries key their entry rules on a US visa", rows: [["26", "visa-free entry"], ["5", "visa on arrival"], ["5", "e-visa + eTA"]] },
      ...
      { bg: "hegra-qasr-alfarid", bgPos: "center 40%", type: "list", eyebrow: "Group 2", heading: "On arrival and online.", rows: [
        ...
        { flag: "🇹🇷", name: "Turkey · Kuwait · Morocco · Taiwan", value: "e-visa", color: LIFT_AMBER },
        { flag: "🇶🇦", name: "Qatar", sub: "any nationality", value: "easier eTA", color: LIFT_AMBER },
      ] },
      { bg: "passport-stamps", bgPos: "center 30%", type: "text", eyebrow: "The fine print", heading: "Read before you fly.", lines: ["Some countries require the US visa to be multiple-entry", "Saudi, Egypt and Albania require it already used at least once", "This is the Indian-passport list - every rule is nationality-scoped, so it does not carry over to other passports"] },
      { bg: "earthrise", bgPos: "center 35%", type: "cta", headline: "Check your passport<br>+ US visa combo.", sub: "All 36 unlocks for Indian passports, with the official source for each." },
    ],
  },
  {
    slug: "p05-cbi-menu", source: "Source: each program's official portal, July 2026",
    slides: [
      { type: "cover", photo: "vanuatu-beach", pos: "center 55%", headline: `Every passport you can<br>${hl("legally buy")} in 2026.`, sub: "22 programs are on the books - only 13 will actually take your money." },
      { bg: "dominica-soufriere-bay", bgPos: "center 40%", type: "list", eyebrow: "The menu · part 1", heading: "Under $250K.", rows: [
        { flag: "🇳🇷", name: "Nauru", sub: "$65K promo", value: "$90K" },
        { flag: "🇸🇹", name: "Sao Tome", sub: "$95K, family of 4", value: "$90K" },
      ...
      { bg: "cappadocia-balloons", bgPos: "center 35%", type: "list", eyebrow: "The menu · part 2", heading: "$250K and up.", rows: [
        ...
        { flag: "🇰🇳", name: "St Kitts", sub: "oldest, since 1984", value: "$250K" },
      ...
      { bg: "valletta-skyline", bgPos: "center 35%", type: "text", eyebrow: "Closed or not real", heading: "Doors that do not open.", lines: ["Malta - struck down by the EU court, April 2025", "North Macedonia - legislated, never operational", "Botswana - announced, not yet law", "Samoa - zero investors have completed it"], note: "All prices are minimums before mandatory fees." },
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "us-capitol-west", bgPos: "center 55%", type: "text", eyebrow: "The deadline", heading: "Today's price is the floor.", lines: ["Thresholds get a CPI-based increase on 1 January 2027", "Then again every 5 years", "Jobs must materialize - the green card isn't guaranteed"] },
  ...
  },
  {
    ...
    slides: [
      ...
      { bg: "railay-beach-krabi", bgPos: "center 40%", type: "list", eyebrow: "Tier 1", heading: "No income minimum.", rows: [
        { flag: "🇹🇭", name: "Thailand DTV", sub: "5 years · THB 500K savings", value: "$0/mo", color: LIFT_GREEN },
      ...
      { bg: "rio-sugarloaf-sunrise", bgPos: "center 35%", type: "list", eyebrow: "Tier 2", heading: "The budget tier.", rows: [
        ...
        { flag: "🇦🇪", name: "UAE", sub: "48h · ~$57 fee", value: "$3,500/mo" },
      ] },
      { bg: "kirkjufell-iceland", bgPos: "center 30%", type: "list", eyebrow: "Tier 3", heading: "The expensive tier.", rows: [
        { flag: "🇯🇵", name: "Japan", sub: "6-month visa · 6-month cooloff", value: "~$5,000/mo" },
        { flag: "🇪🇪", name: "Estonia", value: "EUR 4,500/mo" },
        { flag: "🇧🇿", name: "Belize", value: "$75K/yr" },
        { flag: "🇮🇸", name: "Iceland", sub: "world's highest floor · 180-day visa", value: "~$8,000/mo", color: LIFT_RED },
      ] },
      { bg: "petronas-towers-kl", bgPos: "center 30%", type: "text", eyebrow: "The quirks", heading: "Fine print worth knowing.", lines: ["Malaysia: $24K/yr for tech workers, $60K for everyone else", "Japan: 6-month mandatory exit before you can reapply", "Singapore has no nomad visa - $22.5K online is a tech work pass"] },
      { bg: "earthrise", bgPos: "center 35%", type: "cta", headline: "Every nomad visa,<br>floors and fees.", sub: "Income floors, durations and costs, from official sources." },
    ],
  },
  {
    slug: "p08-stkitts-vs-india", flag: "kn", source: "Source: every destination's official inbound policy, July 2026",
    slides: [
      { type: "cover", photo: "stkitts-timothy-hill", pos: "center 55%",  headline: `A passport you can buy<br>does ${hl("double")} an Indian one.`, sub: "St Kitts and Nevis: 115 destinations vs India's 52." },
      ...
      { type: "stat", bg: "taj-mahal", bgPos: "center 30%", eyebrow: "India", value: "52", title: "destinations on the same honest score", rows: [["23", "visa-free"], ["23", "on arrival"], ["6", "eTA"]], note: "E-visas never counted." },
  ...
  },
  {
    ...
    slides: [
      ...
      ], note: "Same job, four times the odds." },
      ...
      { bg: "supreme-court-dusk", bgPos: "center 35%", type: "text", eyebrow: "And the $100,000 fee?", heading: "Struck down. For now.", lines: ["Presidential proclamation, September 2025", "Struck down in federal court, June 2026", "Not currently collected - the government is appealing"] },
  ...
  },
  {
    ...
    slides: [
      ...
      ], note: "The average US Social Security check clears every rung." },
      ...
      { bg: "milford-sound", bgPos: "center 45%", type: "text", eyebrow: "The other end of the ladder", heading: "New Zealand, age 66+.", lines: ["NZD 750,000 invested for two years", "NZD 500,000 in living funds", "NZD 60,000 a year in income", "For a TEMPORARY 2-year visitor visa"] },
  ...
  },
  {
    ...
    slides: [
      { type: "cover", photo: "hollywood-sign", pos: "center 42%",  headline: `The US has a visa for<br>being ${hl("extraordinary")}.`, sub: "No cap, no lottery - just the O-1." },
      { bg: "pantages-marquee-night", bgPos: "center 30%", type: "stat", eyebrow: "The O-1, extraordinary ability", value: "0", title: "annual cap", rows: [["85,000", "H-1B cap"], ["None", "O-1 cap"], ["None", "lottery"]] },
      { bg: "arri-cinema-camera", bgPos: "center 40%", type: "text", eyebrow: "Who qualifies", heading: "Two doors.", lines: ["O-1A: sciences, education, business, athletics", "O-1B: arts, film and television", "The bar: sustained national or international acclaim - awards, major press, judging others' work"] },
      ...
      { bg: "michigan-stadium", bgPos: "center 40%", type: "text", eyebrow: "Who actually uses it", heading: "Not just Nobel winners.", lines: ["Researchers and founders", "Athletes and coaches", "Designers, chefs, film crews", "If your field has a top, and you're near it"] },
  ...
  },
  {
    ...
    slides: [
      { type: "cover", photo: "buenos-aires-obelisco-sunset", pos: "center 30%", 
        ...
        sub: "Argentina gives you citizenship after 2 years of residence — no investment, no language test." },
      { bg: "perito-moreno-glacier", bgPos: "center 45%", type: "stat", eyebrow: "The deal",
        ...
        note: "Written into the Constitution since 1853, reaffirmed by courts in 2026." },
      { bg: "buenos-aires-congreso-sunset", bgPos: "center 40%", type: "text", eyebrow: "What it actually takes",
        heading: "Five things.",
        lines: ["18 or older", "2 continuous years in Argentina", "Lawful income: job, pension, or remote work", "Clean criminal record", "No language exam, keep your citizenship"] },
      { bg: "iguazu-falls", bgPos: "center 42%", type: "stat", eyebrow: "Why it is worth it",
        ...
        note: "Once granted, citizenship can only be revoked by a judge, for fraud." },
      { bg: "casa-rosada", bgPos: "center 42%", type: "text", eyebrow: "The one to ignore",
        heading: "Not the “investment” one.",
        lines: ["2025: 30-day citizenship for investors announced", "2026: courts struck down its legal basis", "Tender suspended, no price ever set", "Not real yet — we only show what is"] },
      { bg: "puerto-madero", bgPos: "center 55%", type: "cta", headline: "Real paths to<br>real passports.", sub: "Official sources, honest scores, no hype." },
    ],
  },
  {
    ...
    slides: [
      ...
      { bg: "chichen-itza", bgPos: "center 40%", type: "list", eyebrow: "The residency clock",
        ...
        rows: [
          { flag: "🇦🇷", name: "Argentina", sub: "any nationality", value: "2 years", color: LIFT_GREEN },
          { flag: "🇲🇽", name: "Mexico", sub: "Mexican spouse, or Latin American/Iberian", value: "2 years", color: LIFT_GREEN },
      ...
      { bg: "zocalo-cathedral", bgPos: "center 45%", type: "text", eyebrow: "The extra homework",
        ...
        lines: ["Argentina: no language, history, or investment requirement", "Mexico: a Spanish exam, plus history and culture", "History/culture exam waived for refugees, minors, 60+", "Both let you keep your passport - no renunciation"] },
      { bg: "reforma-skyline", bgPos: "center 55%", type: "stat", eyebrow: "Mexico's residency ticket",
        value: "$4,570", title: "a month in passive income, Mexico's residency visa minimum",
        rows: [["$77,015", "or in savings"], ["6 / 12 mo", "income / savings track record"], ["4 yrs", "temporary residency granted"]],
        note: "Priced in Mexico's inflation-proof UMA, not dollars; Argentina's Rentista visa has no published minimum." },
      { bg: "casa-rosada", bgPos: "center 42%", type: "list", eyebrow: "What the passport gets you",
        ...
        note: "Both reach Schengen and Japan visa-free; e-visas never count toward our score." },
      { type: "cta", headline: "Every citizenship law,<br>side by side.", sub: "Compare any two passports' real paths to citizenship, straight from the law." },
    ],
  },
  {
    slug: "p15-saotome", flag: "st", source: "Source: official program portal, cip.gov.st, July 2026",
    slides: [
      { type: "cover", photo: "saotome-beach", pos: "center 55%",
        headline: `A citizenship deal built<br>for the ${hl("whole family")}.`,
        sub: "Sao Tome and Principe: $95,000 covers up to four people." },
      { bg: "dollar-bills", bgPos: "center 30%", type: "stat", eyebrow: "Sao Tome and Principe · citizenship by investment",
        value: "$95,000", title: "covers a family of up to 4 - $90,000 for a single applicant",
        rows: [["$23,750", "per person, family of 4"], ["$5,000", "each extra dependent"], ["0", "visits required"]],
        note: "A non-refundable donation to the National Transformation Fund. No real estate option." },
      { bg: "wing-over-ocean", bgPos: "center 65%", type: "stat", eyebrow: "What it reaches",
        value: "45", title: "destinations without a pre-arranged visa",
        rows: [["21", "visa-free"], ["22", "on arrival"], ["2", "eTA"]],
        note: "E-visas never counted in our score." },
      { bg: "passport-desk", bgPos: "center 45%", type: "text", eyebrow: "The fine print", heading: "Two islands, one paperwork trail.",
        lines: ["Citizenship runs on a blockchain-enabled system", "Dual citizenship allowed, passed to future generations", "Applications go only through a licensed marketing agent"] },
      { bg: "earthrise", bgPos: "center 35%", type: "cta", headline: "See every CBI<br>program, priced.", sub: "13 programs will actually take your money in 2026. Compare all of them." },
    ],
  },
];
