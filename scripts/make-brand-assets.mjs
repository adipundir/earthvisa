...
// Shared card shell (Instrument v2: Archivo, cool near-white ground, red accent).
...
const card = (inner, bg = "#F6F7F9") =>
  `${FONT}<div style="width:1270px;height:760px;background:${bg};box-sizing:border-box;padding:96px 100px;font-family:'Archivo',system-ui,sans-serif;color:#0B0E14;position:relative;display:flex;flex-direction:column;justify-content:center">${inner}<div style="position:absolute;bottom:70px;left:100px;font-size:24px;color:#D9251C;font-weight:600">earthvisa.in</div></div>`;
...
await renderHTML(
  card(
    `<div style="display:flex;align-items:center;gap:20px;margin-bottom:44px">${mark(66, "#0B0E14")}<span style="font-size:44px;font-weight:700;letter-spacing:-.02em">Earth Visa</span></div>
     <div style="font-size:86px;font-weight:800;line-height:1.02;letter-spacing:-.02em;max-width:1000px">What can your passport do?</div>
     <div style="font-size:33px;color:#525E6E;margin-top:30px;max-width:930px;line-height:1.32">Visa-free travel, entry rules, official fees and document checklists for all 199 passports - from government sources only.</div>`
  ),
  1270, 760, "gallery-1-hero.png"
);
await renderHTML(
  card(
    `<div style="display:flex;align-items:center;gap:16px;margin-bottom:52px">${mark(48, "#0B0E14")}<span style="font-size:30px;font-weight:700;letter-spacing:-.02em">Earth Visa</span></div>
     <div style="font-size:60px;font-weight:800;letter-spacing:-.02em;line-height:1.05;margin-bottom:44px">Built on one rule</div>
     <div style="display:flex;flex-direction:column;gap:26px;font-size:34px;color:#525E6E">
       <div style="display:flex;align-items:center;gap:20px"><span style="color:#D9251C;font-weight:700">✓</span> Official government sources only - never aggregators</div>
       <div style="display:flex;align-items:center;gap:20px"><span style="color:#D9251C;font-weight:700">✓</span> Visa fees, VFS charges & document checklists</div>
       <div style="display:flex;align-items:center;gap:20px"><span style="color:#D9251C;font-weight:700">✓</span> Passport rankings & proof-of-funds guides</div>
       <div style="display:flex;align-items:center;gap:20px"><span style="color:#D9251C;font-weight:700">✓</span> Free - no login, no ads, no tracking</div>
     </div>`
  ),
